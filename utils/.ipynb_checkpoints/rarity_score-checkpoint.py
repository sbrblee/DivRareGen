...
Original paper: 
Han, J., Choi, H., Choi, Y., Kim, J., Ha, J. W., & Choi, J. (2023). Rarity Score: A New Metric to Evaluate the Uncommonness of Synthesized Images. In International Conference on Learning Representations (ICLR). International Conference on Learning Representations.
...
from utils.improved_precision_recall import compute_pairwise_distances
